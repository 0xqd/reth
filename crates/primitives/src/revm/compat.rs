use crate::{
    ...
    Account, Address, TransactionKind, KECCAK_EMPTY, U256,
};
...
/// TODO: remove it later, no need
pub fn is_log_equal(revm_log: &Log, reth_log: &AlloyLog) -> bool {
    revm_log.address == reth_log.address &&
        revm_log.data.data == reth_log.data.data &&
